...
- **Recomendaciones:**
    ...
    - **MUY IMPORTANTE:** Asegúrate de incluir la etiqueta `[TÍTULO: Nombre de la Película, AÑO: YYYY][TRAILER_PLACEHOLDER]` por CADA película que recomiendes, justo después de la descripción de la película. NO inventes el año si no estás seguro. NO incluyas frases como 'Tráiler no disponible' o similares; el sistema se encargará de eso.
